...
@Tag(name = "Autenticação", description = "Recurso para proceder com a atutenticação na API")
@Slf4j
...
public class AutenticacaoController {
    ...
    @Operation(summary = "Autenticar na API", description = "Recurso de autenticação na API",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Autenticação realizada com sucesso e o retorno de um bearer token",
