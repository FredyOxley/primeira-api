...
public class ClienteIT {
    ...
    @Test
    public void buscarCliente_ComPaginacaoPeloPeloCliente_RetornarClientesComStatus200 () {
    ...
    @Test
    public void buscarCliente_ComPaginacaoPeloPeloCliente_RetornarErrorMessageComStatus403 () {
        ErrorMessage responseBody =  testClient
                .get()
                .uri("/api/v1/clientes")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "bia@email.com", "123456"))
    ...
    public void buscarCliente_ComDadosDoTokenDeCliente_RetornarClienteComStatus200 () {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("06596579026");
    ...
    @Test
    public void buscarCliente_ComDadosDoTokenDeAdmin_RetornarErrorMessageComStatus200 () {
        ErrorMessage responseBody =  testClient
                .get()
                .uri("/api/v1/clientes/detalhes")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
